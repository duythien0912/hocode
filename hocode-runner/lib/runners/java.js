...
module.exports = {
  ...
  testIntegration(opts, runCode, fail) {
    ...
    fs.copySync('frameworks/java/src/test/java/CwRunListener.java', `${opts.dir}/src/test/java/CwRunListener.java`);
...
function buildAndTest(opts, runCode) {
  ...
  buildGradle = manipulateFileSync(`frameworks/java/build.gradle`, `${opts.dir}/build.gradle`, templateOptions);
